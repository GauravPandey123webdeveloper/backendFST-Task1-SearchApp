...
This Node.js application allows users to search for books and movies from predefined arrays.

## Problem Statement

Create a Node.js application that enables users to search for books and movies available in arrays. Users should be able to search for books and movies by passing query params. 
...
Here are the predefined arrays containing data for books and movies:
